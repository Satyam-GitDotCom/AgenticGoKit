...
func factory(cfg core.LLMProviderConfig) (core.ModelProvider, error) {
	...
	wrapper, err := llm.NewFoundryLocalAdapterWrapped(baseURL, cfg.Model, cfg.MaxTokens, float32(cfg.Temperature))
	if err != nil {
		return nil, err
	}
...
func init() {
	core.RegisterModelProviderFactory("foundrylocal", factory)
}
